...
class Reina(blanca_o_negra: Boolean, posicion: Posicion): Ficha(blanca_o_negra, posicion, false) {

    fun movimientoReina(ficha: Reina,  tablero : Tablero): Reina {
        var posFinalY = -1
        var posFinalX = -1
        ...
        while ((posFinalX < 0 || posFinalX > 7) || (posFinalY < 0 || posFinalY > 7) || !(posibilidadesMovimientoReina(posFinalY, posFinalX, tablero))) { // PARA EVITAR QUE DE ERROR SI EL USUARIO ESCRIBE UNA CASILLA INVÁLIDA (POR EJEMPLO: P, o -1)
            ...
            print("En que FILA quiere mover la REINA: ")
            posFinalY = readln().toIntOrNull() ?: -1
            print("En que COLUMNA quiere mover la REINA: ")
    ...
    private fun posibilidadesMovimientoReina(posFinalY: Int, posFinalX: Int,  tablero : Tablero): Boolean {
