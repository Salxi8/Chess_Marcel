...
class Alfil(blanca_o_negra: Boolean, posicion: Posicion): Ficha(blanca_o_negra, posicion, false) {

    fun movimientoAlfil(ficha: Alfil, tablero: Tablero): Alfil {
        var posFinalY = -1
        var posFinalX = -1
        ...
        while ((posFinalX < 0 || posFinalX > 7) || (posFinalY < 0 || posFinalY > 7) || !(posibilidadesMovimientoAlfil(posFinalY, posFinalX, tablero))) { // PARA EVITAR QUE DE ERROR SI EL USUARIO ESCRIBE UNA CASILLA INVÁLIDA (POR EJEMPLO: P, o -1)
            ...
            print("En que FILA quiere mover el ALFIL: ")
            posFinalY = readln().toIntOrNull() ?: -1
            print("En que COLUMNA quiere mover el ALFIL: ")
    ...
    private fun posibilidadesMovimientoAlfil(posFinalY: Int, posFinalX: Int, tablero: Tablero): Boolean {
