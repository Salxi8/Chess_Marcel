class Torre(blanca_o_negra: Boolean, posicion: Posicion, seleccionada: Boolean)
    ...
    fun movimientoTorre(tablero : Tablero, reiEncontrado : Rei){
        ...
        val auxTorreJaque = Torre(blanca_o_negra, Posicion(posFinalY, posFinalX), false)
        tablero.tablero[posFinalY][posFinalX] = auxTorreJaque
